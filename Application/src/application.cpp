...
#pragma endregion

  {
    ...
    mainScene.loadModel(resPath + "/3dModels/cyborg/cyborg.obj", "cube_final2",
                        "cyborg");
    mainScene.loadModel(resPath + "/3dModels/nanosuit/nanosuit.obj",
                        "cube_final2", "nanosuit", true);
    mainScene.loadModel(resPath + "/3dModels/hammer/hammer.obj", "cube_final2",
                        "hammer", true);
