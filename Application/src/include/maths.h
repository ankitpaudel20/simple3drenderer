...
struct vec2_T {
    ...
    vec2_T() { x = y = 0; }
    explicit vec2_T(const T& a) : x(a), y(a) {}
    vec2_T(const T& a, const T& b) : x(a), y(b) {}
    ...
    vec2_T<T> operator+(const T& a) const {
...
struct vec3_T {
    ...
    vec3_T() { x = y = z = 0; }
    explicit vec3_T(const T& a) : x(a), y(a), z(a) {}
    vec3_T(const T& a, const T& b, const T& c) : x(a), y(b), z(c) {}
...
struct vec4_T {
    ...
    vec4_T() { x = y = z = w = 0; }
    explicit vec4_T(const T& a) : x(a), y(a), z(a), w(a) {}
    vec4_T(const T& a, const T& b, const T& c, const T& d) : x(a), y(b), z(c), w(d) {}
    vec4_T(const glm::vec4 &in) : x(in.x), y(in.y), z(in.z), w(in.w) {}
    vec4_T(glm::vec4 &in) : x(in.x), y(in.y), z(in.z), w(in.w) {}

    template <class U>
    vec4_T(const vec3_T<U> &in) : x(in.x), y(in.y), z(in.z), w(1) {}
